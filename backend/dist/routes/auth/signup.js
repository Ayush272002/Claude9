...
router.post("/login", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield database_js_1.default.getInstance().authenticateUser(username, password);
    if (!user) {
...
router.post("/register", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield database_js_1.default.getInstance().createUser(username, password);
    if (!user) {
...
router.get("/profile", authMiddleware_js_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield database_js_1.default.getInstance().getUserById(userId);
    if (!user) {
        res.status(404).send("User not found");
        return;
    }
 ...
 */
router.get("/timetables", authMiddleware_js_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const userId = req.userId;
    const timetables = yield database_js_1.default.getInstance().getTimetablesByUser(userId);
    if (!timetables) {
...
router.get("/username/:uuid", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield database_js_1.default.getInstance().getUserById(req.params.uuid);
    if (!user) {
        res.status(404).send("User not found");
        return;
    }
